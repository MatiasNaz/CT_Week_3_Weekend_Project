...
# class RentalCalc():
#     def __init__(self):
#         self.Investment = 58000
#         self.Rent = 3000
#         self.Expenses = 1800
    
#     def Calculator(self):
#         Cashflow = {self.Rent} - {self.Expenses}
#         Net_Profit = Cashflow * 12
#         ROI = (Net_Profit / {self.Investment}) * 100
#         print(ROI)

# Calculator = RentalCalc()
...
# Have user input total investment amount.
    ...
    def Add_Investment(self):
        self.Investment = int(input("Please enter your total cash investment in digits: "))
...
# Have user input total rental income.
    ...
    def RentIncome(self):
        self.Rent = int(input("Please enter your monthly rent income in digits: "))
...
# Have user input total expenses.
    ...
    def Total_Expenses(self):
        self.Expenses = int(input("Please enter your total expenses in digits: "))
...
# Total_Investment =  58000
# Rent = 3000
# Expenses = 1800

# $3000.00 - $1800.00 = $1200.00 total cashflow
